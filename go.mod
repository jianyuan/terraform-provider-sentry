...
require (
	...
	github.com/orange-cloudavenue/terraform-plugin-framework-superschema v1.9.1 // indirect
	github.com/orange-cloudavenue/terraform-plugin-framework-supertypes v0.5.0 // indirect
