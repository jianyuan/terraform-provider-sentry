...
func WithEnumSetAttributeStringElements(base schema.SetAttribute, choices []string) schema.SetAttribute {
	...
	base.Validators = append(base.Validators, setvalidator.ValueStringsAre(stringvalidator.OneOf(choices...)))
