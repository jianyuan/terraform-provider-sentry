...
func fillDataSourceOrganizationModel(ctx context.Context, m *datasource_organization.OrganizationModel, resp apiclient.GetOrganizationResponse) (diags diag.Diagnostics) {
